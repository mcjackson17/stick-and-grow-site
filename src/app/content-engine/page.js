      ...
      <section className="relative z-10 p-8 md:p-16 border-b-[3px] border-black bg-[#f4f4f5]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg font-bold text-gray-600 max-w-3xl mx-auto leading-relaxed">
              The sprint produces published work every week. It also builds the substrate underneath it, and that part is yours to keep whether we carry on together or not.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { title: 'An organized content library', text: 'Everything published, structured and searchable, rather than scattered across drives and someone\u2019s laptop.' },
              { title: 'A tagging system', text: 'Content mapped to themes, buyer stages and products, so you can find what exists before paying to make it twice.' },
              { title: 'Voice guides that get used', text: 'The working rules that keep output sounding like you, whoever or whatever is drafting it. Not a brand deck nobody opens.' },
            ].map((item, i) => (
